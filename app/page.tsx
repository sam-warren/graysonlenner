        ...
        <div className='relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto'>
          <div className='space-y-8'>
            <div className='space-y-6'>
              ...
              <h1 className='text-6xl sm:text-7xl lg:text-8xl font-thin text-white leading-tight uppercase'>
                Grayson
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div className='space-y-6'>
              ...
              <p className='text-lg text-slate-600 leading-relaxed'>
                Rooted in Victoria, BC, Grayson Lenner&apos;s music is
                characterized by acoustic guitars, harmonies, rich textures, and
                captivating melodies. His sound draws inspiration from the
                diverse worlds of pop, folk, and alternative genres.
              </p>
              <p className='text-lg text-slate-600 leading-relaxed'>
